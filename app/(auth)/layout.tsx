            ...
            <section className="auth-right-section">
                <div className="z-10 relative lg:mt-4 lg:mb-16">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <cite className="auth-testimonial-author">- Shashank J</cite>
                ...
                <div className="flex-1 relative">
                    <Image src="/assets/images/dashboard.png" alt="Dahboard Preview" width={1440} height={1150} className="auth-dashboard-preview absolute top-0" />
                </div>
            </section>
        </main>
    )
